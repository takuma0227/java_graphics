public class kadai3d3 {
	...
	public static void main(String[] args) {
		...
		Win3D W1 = new Win3D("フラットシェーディング", X_SIZE, Y_SIZE, COLor.WHITE);
		...
		for(int k = 0; k < 20; k++) {
			...
			for(int i = 0; i < Sf.n; i++)
				paint(W1, Sf.getPolygon(i), li, COLor.CYAN);	//回転体の描画
	...
	//	ポリゴンを塗りつぶす
	static void paint(Win3D W1, Polygon Pf, Vector li, COLor ca) {
